...
import static zeta.android.myntra.interceptors.MyntraHttpHeadersInterceptorConst.KEY.KEY_ACCEPT_LANGUAGE;
import static zeta.android.myntra.interceptors.MyntraHttpHeadersInterceptorConst.KEY.KEY_CONTENT_TYPE;
import static zeta.android.myntra.interceptors.MyntraHttpHeadersInterceptorConst.KEY.KEY_SXID;
import static zeta.android.myntra.interceptors.MyntraHttpHeadersInterceptorConst.KEY.KEY_XID;
import static zeta.android.myntra.interceptors.MyntraHttpHeadersInterceptorConst.KEY.KEY_XSRF;
import static zeta.android.myntra.interceptors.MyntraHttpHeadersInterceptorConst.VALUE.VALUE_ACCEPT;
import static zeta.android.myntra.interceptors.MyntraHttpHeadersInterceptorConst.VALUE.VALUE_ACCEPT_LANGUAGE;
import static zeta.android.myntra.interceptors.MyntraHttpHeadersInterceptorConst.VALUE.VALUE_CONTENT_TYPE;
import static zeta.android.myntra.interceptors.MyntraHttpHeadersInterceptorConst.VALUE.VALUE_ZERO_EMPTY;
